      ...
      <section className="py-20 dark:bg-gray-800 dark:text-gray-100">
        <div className="w-[1200px] mx-auto">
          ...
          <div className="flex flex-wrap items-stretch -mx-4">
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 font-sans">
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 bg-[#0152A8]">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 text-white font-sans">
                <div className="space-y-2">
