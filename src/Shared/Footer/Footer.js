...
<div>
    ...
    <div  className="link link-hover mt-4 py-1">Emergency Checkup</div  > 
    <div  className="link link-hover py-1 ">Monthly Checkup</div  >  
    <div  className="link link-hover py-1 ">Weekly Checkup</div  > 
    <div  className="link link-hover py-1">Deep Checkup</div  >
  </div> 
  <div>
    <span className="footer-title">Oral Health</span> 
    <div  className="link link-hover mt-4 py-1">Fluoride Treatment</div  > 
    <div  className="link link-hover py-1">Cavity Filling</div  > 
    <div  className="link link-hover py-1">Teeth Whitening</div  > 

  </div> 
  <div>
    <span className="footer-title">Our Address</span> 
    <div  className="link link-hover mt-4">New York - 101010 Hudson</div  > 
...
<div className=" px-10 py-4 text-base-content border-base-300">
  <div className="items-center text-center grid-flow-col mt-6">
